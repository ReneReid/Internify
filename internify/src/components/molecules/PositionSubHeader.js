...
function PositionSubHeader(props) {
    ...
    return(
        <div>
            <div>
            <h3>Position</h3>
            <CheckBox name={"Internship"} label={"Internship"} onChange={handleChange} checked={state.Internship}/>
            <CheckBox name={"Coop"} label={"Co-op"} onChange={handleChange} checked={state.Coop}/>
            <CheckBox name={"NewGrad"} label={"New Grad"} onChange={handleChange} checked={state.NewGrad}/>
            <CheckBox name={"PartTime"} label={"Part-time"} onChange={handleChange} checked={state.PartTime}/>
            </div>
        </div>
    )
}
